...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "↺";
    			add_location(button, file, 44, 6, 883);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	let a;
    	let t;
    	let if_block = /*finished*/ ctx[2] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			toggle_class(a, "finished", /*finished*/ ctx[2]);
    			add_location(a, file, 42, 4, 806);
    			add_location(h3, file, 41, 2, 797);
    			add_location(section, file, 40, 0, 785);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			append_dev(h3, a);
    			a.innerHTML = /*typedChars*/ ctx[1];
    			append_dev(h3, t);
    			if (if_block) if_block.m(h3, null);
    		},
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*typedChars*/ 2) a.innerHTML = /*typedChars*/ ctx[1];
    			if (dirty & /*url*/ 1) {
    				attr_dev(a, "href", /*url*/ ctx[0]);
    			}
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const typeChar = () => {
    		if (index < phrase.length) {
    			$$invalidate(1, typedChars += phrase[index]);
    			index += 1;
    		} else {
    	...
    	const replay = delay => {
    		$$invalidate(1, typedChars = "");
    		$$invalidate(2, finished = false);
    		start(delay);
    	};

    	onMount(() => start());
    	const writable_props = ["phrase", "delay", "speed", "url"];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<mfs-typewriter> was created with unknown prop '${key}'`);
    	});

    	const click_handler = () => replay(0);

    	$$self.$$set = $$props => {
    		if ("phrase" in $$props) $$invalidate(4, phrase = $$props.phrase);
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("typedChars" in $$props) $$invalidate(1, typedChars = $$props.typedChars);
    ...
    class App extends SvelteElement {
    	constructor(options) {
    		...
    		init(
    			...
    			create_fragment,
    			safe_not_equal,
    			{ phrase: 4, delay: 5, speed: 6, url: 0 }
    		);
