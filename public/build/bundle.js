...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			button.textContent = "↺";
    			attr_dev(button, "class", "svelte-1o1rlu0");
    			add_location(button, file, 43, 6, 843);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", "svelte-1o1rlu0");
    			add_location(a, file, 39, 4, 716);
    			attr_dev(h3, "class", "svelte-1o1rlu0");
    			add_location(h3, file, 38, 2, 707);
    			attr_dev(section, "class", "svelte-1o1rlu0");
    			add_location(section, file, 37, 0, 695);
    		},
    ...
    class App extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance, create_fragment, safe_not_equal, { phrase: 3, delay: 4, speed: 5 });
